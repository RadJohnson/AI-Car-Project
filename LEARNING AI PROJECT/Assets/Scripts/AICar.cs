...
public class AICar : MonoBehaviour
{
    ...
    */
    ...
    void FixedUpdate()
    {
        ...
        {
            if (Physics.Raycast(suspensionTransforms[i].position, -transform.up, out RaycastHit intersectPoint, suspensionMaxLength + wheelRadius, ~layersToIgnore))//This may need to change
            {
                ///Suspension
    ...
    public void AICarInput(float leftRight, float forwardBack)
    {
        steerAngle += leftRight;
        engineForceMultiplier += forwardBack;
